      ...
      try {
        await emailService.enviarEmail(
          ...
          <div style="padding: 20px; background-color: #f5f5f5;">
              ...
              <div style="background-color: white; padding: 20px; border-radius: 8px; margin: 20px 0;">
                  <h3 style="color: #DC2626; margin-bottom: 15px;">Morada do Utente</h3>
                  <ul style="list-style: none; padding: 0;">
                      <li style="margin-bottom: 10px;"><strong>Distrito:</strong> ${dadosUtente.morada.distrito}</li>
                      <li style="margin-bottom: 10px;"><strong>Concelho:</strong> ${dadosUtente.morada.concelho}</li>
                      <li style="margin-bottom: 10px;"><strong>Rua:</strong> ${dadosUtente.morada.rua}</li>
                      <li style="margin-bottom: 10px;"><strong>Código-Postal:</strong> ${dadosUtente.morada.codigoPostal}</li>
                      <li style="margin-bottom: 10px;"><strong>Número da Porta:</strong> ${dadosUtente.morada.numPorta}</li>
                  </ul>
              </div>
