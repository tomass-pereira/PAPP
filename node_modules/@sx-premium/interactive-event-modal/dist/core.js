...
import { useState, useEffect, useContext, useRef as useRef$1 } from 'preact/hooks';
import { Fragment as Fragment$1, createContext, render, createElement } from 'preact';
import { createPortal, useContext as useContext$1, useEffect as useEffect$1, useRef } from 'preact/compat';

const createInputField = (field) => {
    const reactiveInputField = signal({
        ...field,
...
function EditIcon({ color }) {
    return (jsx(Fragment, { children: jsx("svg", { className: "sx__modal-edit-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 -960 960 960", width: "24", children: jsx("path", { fill: color, d: "M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z" }) }) }));
}

function TrashIcon({ color }) {
    return (jsx(Fragment, { children: jsx("svg", { className: "sx__modal-trash-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 -960 960 960", width: "24", children: jsx("path", { fill: color, d: "M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z" }) }) }));
}
...
function EventDisplay({ $app, calendarEvent }) {
    ...
    const additionalFieldsId = useState(additionalFields ? randomStringId$2() : undefined)[0];
    useEffect(() => {
        if (additionalFields) {
    ...
    return (jsx(Fragment, { children: jsxs(Fragment$1, { children: [jsxs("header", { className: "sx__interactive-event-modal__header", children: [jsx("button", { className: "sx__modal-action-button", onClick: openForm, children: jsx(EditIcon, { color: 'rgb(128, 128, 128)' }) }), jsx("button", { className: "sx__modal-action-button", onClick: openDeleteActions, children: jsx(TrashIcon, { color: 'rgb(128, 128, 128)' }) })] }), jsxs("div", { className: "sx__has-icon sx__event-modal__title", children: [jsx("div", { style: {
                                backgroundColor: `var(--sx-color-${eventColorName}-container)`,
                            }, "data-color": eventColorName, className: "sx__interactive-event-modal__color-icon sx__event-icon" }), calendarEvent.title] }), jsxs("div", { className: "sx__has-icon sx__interactive-event-modal__time", children: [jsx(TimeIcon, { strokeColor: iconColor.value }), jsx("div", { dangerouslySetInnerHTML: {
                                __html: getTimeStamp(calendarEvent, $app.config.locale.value),
                            } })] }), Array.isArray(calendarEvent.people) &&
                    calendarEvent.people.length > 0 && (jsxs("div", { className: "sx__has-icon sx__interactive-event-modal__people", children: [jsx(UserIcon, { strokeColor: iconColor.value }), concatenatePeople(calendarEvent.people)] })), calendarEvent.location && (jsxs("div", { className: "sx__has-icon sx__interactive-event-modal__location", children: [jsx(LocationPinIcon, { strokeColor: iconColor.value }), calendarEvent.location] })), calendarEvent.description && (jsxs("div", { className: "sx__has-icon sx__interactive-event-modal__description", children: [jsx(DescriptionIcon, { strokeColor: iconColor.value }), calendarEvent.description] })), additionalFields && (jsx("div", { "data-ccid": additionalFieldsId, className: "sx__interactive-event-modal__additional-fields" }))] }) }));
}
...
function TextField({ initialValue, onChange, label, fieldName, id, errorMessage, }) {
    ...
    const [wrapperClasses, setWrapperClasses] = useState([BASE_WRAPPER_CLASS]);
    useEffect(() => {
    ...
    return (jsx(Fragment, { children: jsxs("div", { class: "sx__form-field", children: [jsxs("div", { className: wrapperClasses.join(' '), children: [jsx("input", { id: id, className: 'sx__text-field-input', value: inputValue, onInput: (e) => handleInput(e.currentTarget.value), name: fieldName, type: "text" }), jsx("label", { className: 'sx__text-field-label', htmlFor: fieldName, children: label })] }), errorMessage && jsx("p", { className: "sx__error-message", children: errorMessage })] }) }));
}
...
function AppWrapper({ $app }) {
    ...
    let appPopupJSX = jsx(AppPopup$1, {});
    if ($app.config.teleportTo)
        appPopupJSX = createPortal(appPopupJSX, $app.config.teleportTo);
    return (jsx(Fragment, { children: jsx("div", { className: classList.join(' '), children: jsxs(AppContext$1.Provider, { value: $app, children: [jsx(AppInput$1, {}), $app.datePickerState.isOpen.value && appPopupJSX] }) }) }));
}
...
function DatePicker({ initialValue, label, onChange, isDarkMode, name, width, disabled, min, max, locale, }) {
    const [datePickerId] = useState(randomStringId$2);
    const [datePicker] = useState(() => createDatePicker({
    ...
    return (jsx(Fragment, { children: jsx("div", { className: 'sx__date-picker-outer-wrapper', id: datePickerId }) }));
}
...
function Textarea({ initialValue, onChange, label, name, errorMessage, }) {
    ...
    return (jsx(Fragment, { children: jsxs("div", { class: "sx__form-field", children: [jsxs("div", { className: wrapperClasses.join(' '), children: [jsx("textarea", { className: 'sx__textarea-input', value: inputValue, onInput: (e) => handleInput(e.currentTarget.value), id: "last_name", type: "text", name: name }), jsx("label", { className: 'sx__textarea-label', htmlFor: name, children: label })] }), errorMessage && jsx("p", { className: "sx__error-message", children: errorMessage })] }) }));
}
...
function AppCheckbox({ initialValue, label, onChange, colorPrimary }) {
    ...
    return (jsx(Fragment$1, { children: jsx("label", { id: checkboxId, className: "sx__app-checkbox", children: isReady && (jsxs(Fragment, { children: [jsx("input", { type: "checkbox", checked: isChecked, onInput: handleOnInput }), jsx("span", { children: label })] })) }) }));
}
...
function AppInput() {
    var _a;
    const $app = useContext$1(AppContext);
...
function AppPopup() {
    ...
    return (jsxs("div", { className: classList.join(' '), style: $app.config.teleportTo.value ? fixedPositionStyle : undefined, children: [jsx("div", { className: "sx__time-picker-popup-label", children: "Select time" }), jsxs("div", { className: "sx__time-picker-time-inputs", children: [jsx(TimeInput, { initialValue: hoursValue, onChange: (newHours) => setHoursValue(newHours), inputRef: hoursRef, nextTabIndexRef: minutesRef, validRange: $app.config.is12Hour.value ? [1, 12] : [0, 23] }), jsx("span", { className: "sx__time-picker-colon", children: ":" }), jsx(TimeInput, { initialValue: minutesValue, onChange: (newMinutes) => setMinutesValue(newMinutes), inputRef: minutesRef, validRange: [0, 59], nextTabIndexRef: OKButtonRef }), $app.config.is12Hour.value && (jsxs("div", { className: "sx__time-picker-12-hour-switches", children: [jsx("button", { type: "button", className: `sx__time-picker-12-hour-switch${$app.timePickerState.isAM.value ? ' is-selected' : ''}`, onClick: () => ($app.timePickerState.isAM.value = true), children: "AM" }), jsx("button", { type: "button", className: `sx__time-picker-12-hour-switch${!$app.timePickerState.isAM.value ? ' is-selected' : ''}`, onClick: () => ($app.timePickerState.isAM.value = false), children: "PM" })] }))] }), jsxs("div", { class: "sx__time-picker-actions", children: [jsx("button", { type: "button", class: "sx__time-picker-action sx__ripple sx__button-cancel", onClick: () => ($app.timePickerState.isOpen.value = false), children: "Cancel" }), jsx("button", { ref: OKButtonRef, type: "button", class: "sx__time-picker-action sx__ripple sx__button-accept", onClick: handleAccept, children: "OK" })] })] }));
}
...
function TimePicker({ initialValue, label, name, onChange, placement, isDarkMode, is12Hour, }) {
    const [timePickerId] = useState(randomStringId$2);
    const [timePicker] = useState(createTimePicker({
    ...
    return (jsx(Fragment, { children: jsx("div", { id: timePickerId }) }));
}
...
function AppCombobox({ items, label, initialSelectedItems, onChange, name, isDarkMode, errorMessage, }) {
    ...
    const [listClasses, setListClasses] = useState('sx__app-combobox__list');
    ...
    return (jsx(Fragment, { children: jsxs("div", { class: "sx__form-field", children: [jsxs("div", { class: "sx__app-combobox-wrapper", id: wrapperId, onClick: toggleOpen, children: [jsxs("div", { class: "sx__app-combobox__input-wrapper", children: [selectedItems.map((item, index) => (jsxs("div", { class: "sx__app-combobox__chip", children: [item, jsx("span", { className: "sx__app-combobox__chip-remove", onClick: () => removeSelected(item), style: { width: '16px', height: '16px' }, children: jsxs("svg", { viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsx("g", { "stroke-width": "0" }), jsx("g", { "stroke-linecap": "round", "stroke-linejoin": "round" }), jsxs("g", { children: [' ', jsx("path", { d: "M19 5L4.99998 19M5.00001 5L19 19", stroke: "#fff", "stroke-width": "2.4", "stroke-linecap": "round", "stroke-linejoin": "round" }), ' '] })] }) })] }, index))), jsx("input", { id: inputId, onInput: handleInput, onKeyDown: handleKeyDown, className: "sx__app-combobox-input", type: "text", placeholder: "Search...", name: name }), jsx("label", { className: 'sx__app-combobox-label', htmlFor: name, children: label })] }), createPortal(jsx("div", { id: listId, class: listClasses, style: {
                                top: wrapperRect.y + wrapperRect.height + 1,
                                left: wrapperRect.x,
                                width: wrapperRect.width,
                            }, children: jsx("ul", { children: filteredItems.map((item, index) => (jsx("li", { onClick: () => clickOnItem(item), children: item }, index))) }) }), document.body)] }), errorMessage && jsx("p", { className: "sx__error-message", children: errorMessage })] }) }));
}

const WarningSign = ({ color = '#a88d00' }) => {
    return (jsxs("svg", { fill: color, width: 24, height: 24, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: [jsx("g", { id: "SVGRepo_bgCarrier", strokeWidth: "0" }), jsx("g", { id: "SVGRepo_tracerCarrier", strokeLinecap: "round", strokeLinejoin: "round" }), jsx("g", { id: "SVGRepo_iconCarrier", children: jsx("path", { "fill-rule": "evenodd", d: "M23,7.44365081 L23,16.5563492 L16.5563492,23 L7.44365081,23 L1,16.5563492 L1,7.44365081 L7.44365081,1 L16.5563492,1 L23,7.44365081 Z M15.7279221,3 L8.27207794,3 L3,8.27207794 L3,15.7279221 L8.27207794,21 L15.7279221,21 L21,15.7279221 L21,8.27207794 L15.7279221,3 Z M12.0003283,17.9983464 C11.4478622,17.9983464 11,17.5506311 11,16.9983464 C11,16.4460616 11.4478622,15.9983464 12.0003283,15.9983464 C12.5527943,15.9983464 13.0006565,16.4460616 13.0006565,16.9983464 C13.0006565,17.5506311 12.5527943,17.9983464 12.0003283,17.9983464 Z M11.0029544,5.99834639 L13.0036109,5.99834639 L13.0036109,13.9983464 L11.0029544,13.9983464 L11.0029544,5.99834639 Z" }) })] }));
};
...
function AppComboboxSingleValue({ items, label, initialSelectedItem, onChange, name, isDarkMode, errorMessage, }) {
    ...
    const [listClasses, setListClasses] = useState('sx__app-combobox__list');
    const [filteredItems, setFilteredItems] = useState(items);
    const [selectedItem, setSelectedItem] = useState(initialSelectedItem === null || initialSelectedItem === void 0 ? void 0 : initialSelectedItem.value);
    const setPopupPosition = (wrapperEl) => {
        setWrapperRect({
            x: wrapperEl.getBoundingClientRect().left,
            y: wrapperEl.getBoundingClientRect().top,
    ...
    return (jsx(Fragment, { children: jsxs("div", { class: "sx__form-field", children: [jsxs("div", { class: "sx__app-combobox-wrapper", id: wrapperId, onClick: toggleOpen, children: [jsxs("div", { class: "sx__app-combobox__input-wrapper", children: [jsx("input", { ref: inputRef, id: inputId, onInput: handleInput, className: "sx__app-combobox-input", type: "text", placeholder: "Search...", name: name }), jsx("label", { className: 'sx__app-combobox-label', htmlFor: name, children: label })] }), createPortal(jsx("div", { id: listId, class: listClasses, style: {
                                top: wrapperRect.y + wrapperRect.height + 1,
                                left: wrapperRect.x,
                                width: wrapperRect.width,
                            }, children: jsx("ul", { children: filteredItems.map((item, index) => (jsx("li", { onClick: () => clickOnItem(item.value), children: item.label }, index))) }) }), document.body)] }), errorMessage && jsx("p", { className: "sx__error-message", children: errorMessage })] }) }));
}

const ADDED_EVENT_CLASS_NAME = 'sx-is-added-event';

const InfoIcon = ({ color = '#0077cc' }) => {
    return (jsxs("svg", { width: 28, height: 28, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsx("g", { id: "SVGRepo_bgCarrier", "stroke-width": "0" }), jsx("g", { id: "SVGRepo_tracerCarrier", "stroke-linecap": "round", "stroke-linejoin": "round" }), jsxs("g", { id: "SVGRepo_iconCarrier", children: [jsx("path", { d: "M12 16.75C11.8019 16.7474 11.6126 16.6676 11.4725 16.5275C11.3324 16.3874 11.2526 16.1981 11.25 16V11C11.25 10.8011 11.329 10.6103 11.4697 10.4697C11.6103 10.329 11.8011 10.25 12 10.25C12.1989 10.25 12.3897 10.329 12.5303 10.4697C12.671 10.6103 12.75 10.8011 12.75 11V16C12.7474 16.1981 12.6676 16.3874 12.5275 16.5275C12.3874 16.6676 12.1981 16.7474 12 16.75Z", fill: color }), jsx("path", { d: "M12 9.25C11.8019 9.24741 11.6126 9.16756 11.4725 9.02747C11.3324 8.88737 11.2526 8.69811 11.25 8.5V8C11.25 7.80109 11.329 7.61032 11.4697 7.46967C11.6103 7.32902 11.8011 7.25 12 7.25C12.1989 7.25 12.3897 7.32902 12.5303 7.46967C12.671 7.61032 12.75 7.80109 12.75 8V8.5C12.7474 8.69811 12.6676 8.88737 12.5275 9.02747C12.3874 9.16756 12.1981 9.24741 12 9.25Z", fill: color }), jsx("path", { d: "M12 21C10.22 21 8.47991 20.4722 6.99987 19.4832C5.51983 18.4943 4.36628 17.0887 3.68509 15.4442C3.0039 13.7996 2.82567 11.99 3.17294 10.2442C3.5202 8.49836 4.37737 6.89472 5.63604 5.63604C6.89472 4.37737 8.49836 3.5202 10.2442 3.17294C11.99 2.82567 13.7996 3.0039 15.4442 3.68509C17.0887 4.36628 18.4943 5.51983 19.4832 6.99987C20.4722 8.47991 21 10.22 21 12C21 14.387 20.0518 16.6761 18.364 18.364C16.6761 20.0518 14.387 21 12 21ZM12 4.5C10.5166 4.5 9.0666 4.93987 7.83323 5.76398C6.59986 6.58809 5.63856 7.75943 5.07091 9.12988C4.50325 10.5003 4.35473 12.0083 4.64411 13.4632C4.9335 14.918 5.64781 16.2544 6.6967 17.3033C7.7456 18.3522 9.08197 19.0665 10.5368 19.3559C11.9917 19.6453 13.4997 19.4968 14.8701 18.9291C16.2406 18.3614 17.4119 17.4001 18.236 16.1668C19.0601 14.9334 19.5 13.4834 19.5 12C19.5 10.0109 18.7098 8.10323 17.3033 6.6967C15.8968 5.29018 13.9891 4.5 12 4.5Z", fill: color })] })] }));
};
...
function AppSelect({ items, label, initialSelectedItem, onChange, name, isDarkMode, errorMessage, }) {
    ...
    const [isOpen, setIsOpen] = useState(false);
    const [listClasses, setListClasses] = useState('sx__app-select__list');
    const [selectedItem, setSelectedItem] = useState((initialSelectedItem === null || initialSelectedItem === void 0 ? void 0 : initialSelectedItem.value) || '');
    const setPopupPosition = (wrapperEl) => {
        setWrapperRect({
            x: wrapperEl.getBoundingClientRect().left,
    ...
    return (jsx(Fragment, { children: jsxs("div", { class: "sx__form-field", children: [jsxs("div", { class: "sx__app-select-wrapper", id: wrapperId, onClick: toggleOpen, children: [jsxs("div", { class: "sx__app-select__input-wrapper", children: [jsx("input", { ref: inputRef, id: inputId, className: "sx__app-select-input", type: "text", readOnly: true, name: name }), jsx("label", { className: 'sx__app-select-label', htmlFor: name, children: label })] }), createPortal(jsx("div", { id: listId, class: listClasses, style: {
                                top: wrapperRect.y + wrapperRect.height + 1,
                                left: wrapperRect.x,
                                width: wrapperRect.width,
                            }, children: jsx("ul", { children: items.map((item, index) => (jsx("li", { onClick: () => clickOnItem(item.value), children: item.label }, index))) }) }), document.body)] }), errorMessage && jsx("p", { className: "sx__error-message", children: errorMessage })] }) }));
}
...
function EventForm({ $app, removeEditAddedEvent }) {
    ...
    const [isFullDayEvent, setIsFullDayEvent] = useState(dateStringRegex.test(modalPlugin.formValues.value.start));
    const [startDate, setStartDate] = useState(modalPlugin.formValues.value.start
        ? toDateString$2(toJSDate$1(modalPlugin.formValues.value.start))
        : '');
    const [startTime, setStartTime] = useState(modalPlugin.formValues.value.start
        ? toTimeString$1(toJSDate$1(modalPlugin.formValues.value.start))
        : '');
    const [endDate, setEndDate] = useState(modalPlugin.formValues.value.end
        ? toDateString$2(toJSDate$1(modalPlugin.formValues.value.end))
        : '');
    const [endTime, setEndTime] = useState(modalPlugin.formValues.value.end
        ? toTimeString$1(toJSDate$1(modalPlugin.formValues.value.end))
        : '');
    const [rruleFreq, setRruleFreq] = useState(() => getInitialFrequency(modalPlugin).value);
    const [rruleUntil, setRruleUntil] = useState(() => getInitialRruleUntil(modalPlugin));
    useEffect(() => {
    ...
    const [saveButtonClasses, setSaveButtonClasses] = useState([
    ...
    const [isInHiddenCalendar, setIsInHiddenCalendar] = useState(false);
    ...
    return (jsx(Fragment, { children: jsxs("div", { className: "sx__event-form", children: [modalPlugin.isEditingRecurringEvent.value && (jsxs("div", { className: "sx__event-form-alert sx__event-form-recurrence-warning", children: [jsx(WarningSign, {}), "You are editing the first in a series of recurring events."] })), isInHiddenCalendar && (jsxs("div", { className: "sx__event-form-alert sx__event-form-info-box", children: [jsx(InfoIcon, {}), "This event is in a hidden calendar."] })), jsx(TextField, { id: titleFieldId, initialValue: modalPlugin.formValues.value.title || '', onChange: (value) => {
                        var _a, _b, _c;
                        ...
                        validateIfShouldValidate();
                                            ...
                                            }, min: (_l = modalPlugin.config.datePicker) === null || _l === void 0 ? void 0 : _l.min, max: (_m = modalPlugin.config.datePicker) === null || _m === void 0 ? void 0 : _m.max, initialValue: startDate, isDarkMode: $app.calendarState.isDark.value, locale: $app.config.locale.value }), !isFullDayEvent && (jsx(TimePicker, { onChange: (newStartTime) => {
                                                var _a, _b, _c;
                                                ...
                                                ? 'bottom-end'
                                                : 'bottom-start', isDarkMode: $app.calendarState.isDark.value, is12Hour: modalPlugin.config.has12HourTimeFormat || false }))] }), jsx("span", { className: 'sx__date-time-until', children: "until" }), jsxs("div", { class: "sx__date-time-picker sx__date-time-end", children: [jsx(DatePicker, { label: ((_t = (_s = modalPlugin.config.fields) === null || _s === void 0 ? void 0 : _s.endDate) === null || _t === void 0 ? void 0 : _t.label) || 'End date', name: ((_v = (_u = modalPlugin.config.fields) === null || _u === void 0 ? void 0 : _u.endDate) === null || _v === void 0 ? void 0 : _v.name) || 'end-date', onChange: (newEndDate) => {
                                                var _a, _b, _c;
                                            ...
                                            }, initialValue: endDate, isDarkMode: $app.calendarState.isDark.value, min: (_w = modalPlugin.config.datePicker) === null || _w === void 0 ? void 0 : _w.min, max: (_x = modalPlugin.config.datePicker) === null || _x === void 0 ? void 0 : _x.max, locale: $app.config.locale.value }), !isFullDayEvent && (jsx(TimePicker, { onChange: (newEndTime) => {
                                                var _a, _b, _c;
                                            ...
                                            }, label: ((_z = (_y = modalPlugin.config.fields) === null || _y === void 0 ? void 0 : _y.endTime) === null || _z === void 0 ? void 0 : _z.label) || '', initialValue: endTime, placement: 'bottom-end', isDarkMode: $app.calendarState.isDark.value, name: ((_1 = (_0 = modalPlugin.config.fields) === null || _0 === void 0 ? void 0 : _0.endTime) === null || _1 === void 0 ? void 0 : _1.name) || 'end-time', is12Hour: modalPlugin.config.has12HourTimeFormat || false }))] })] }), jsx(AppCheckbox, { label: 'Full-day event', initialValue: isFullDayEvent, onChange: (isChecked) => setIsFullDayEvent(isChecked) })] })), showRruleFields && (jsx(Fragment, { children: jsxs("div", { className: 'sx__rrule-wrapper', children: [jsx(AppSelect, { items: getFrequencies(), initialSelectedItem: getInitialFrequency(modalPlugin), label: ((_3 = (_2 = modalPlugin.config.fields) === null || _2 === void 0 ? void 0 : _2.rruleFrequency) === null || _3 === void 0 ? void 0 : _3.label) ||
                                    ...
                                    setRruleFreq(value);
                                }, name: ((_5 = (_4 = modalPlugin.config.fields) === null || _4 === void 0 ? void 0 : _4.rruleFrequency) === null || _5 === void 0 ? void 0 : _5.name) || 'rrule', isDarkMode: $app.calendarState.isDark.value }), jsx(DatePicker, { initialValue: rruleUntil, onChange: (newDate) => {
                                    var _a, _b, _c;
                        ...
                        return (jsxs(Fragment, { children: [field.value.type === 'text' && (jsx(TextField, { id: fieldName, initialValue: modalPlugin.formValues.value[fieldName] || '', onChange: (value) => {
                                        ...
                                        validateIfShouldValidate();
                                    }, label: field.value.label || '', fieldName: fieldName, errorMessage: (_a = modalPlugin.formValidationErrors[fieldName]) === null || _a === void 0 ? void 0 : _a.value }, field.value)), field.value.type == 'select' && (jsx(AppSelect, { items: field.value.items || [], label: field.value.label || '', onChange: (value) => {
                                        var _a, _b;
                                        (_b = (_a = modalPlugin.config.customFields[fieldName].value).onChange) === null || _b === void 0 ? void 0 : _b.call(_a, value);
                                        modalPlugin.formValues.value[fieldName] = value;
                                        validateIfShouldValidate();
                                    ...
                                    })) || undefined, name: fieldName }, field.value)), field.value.type === 'textarea' && (jsx(Textarea, { initialValue: modalPlugin.formValues.value[fieldName] || '', onChange: (value) => {
                                        var _a, _b;
                                        (_b = (_a = modalPlugin.config.customFields[fieldName].value).onChange) === null || _b === void 0 ? void 0 : _b.call(_a, value);
                                        modalPlugin.formValues.value[fieldName] = value;
                                        validateIfShouldValidate();
                                    }, label: field.value.label || '', name: fieldName, errorMessage: (_c = modalPlugin.formValidationErrors[fieldName]) === null || _c === void 0 ? void 0 : _c.value }, field.value)), field.value.type === 'combobox' && (jsx(AppComboboxSingleValue, { items: field.value.items || [], label: field.value.label || '', onChange: (value) => {
                                        var _a, _b;
                                        (_b = (_a = modalPlugin.config.customFields[fieldName].value).onChange) === null || _b === void 0 ? void 0 : _b.call(_a, value);
                                        modalPlugin.formValues.value[fieldName] = value;
                                        validateIfShouldValidate();
                    ...
                    }) })), jsxs("div", { className: 'sx__form-actions', children: [jsx(AppButton, { onClick: saveEvent, additionalClasses: saveButtonClasses.join(' '), children: "Save" }), jsx(AppButton, { onClick: cancel, additionalClasses: 'sx__app-button-outlined', children: "Cancel" })] })] }) }));
}

function DeleteActions({ $app }) {
    const modalPlugin = $app.config.plugins
        .eventModal;
    return (jsxs("div", { children: [jsx("h2", { className: "sx__modal-delete-headline", children: "Are you sure you want to delete this event?" }), jsxs("div", { className: "sx__modal-delete-actions", children: [jsx(AppButton, { additionalClasses: "sx__app-button-outlined", onClick: () => {
                            modalPlugin.modalState.value = 'view';
                        }, children: "Cancel" }), jsx(AppButton, { additionalClasses: "sx__app-button-danger", onClick: () => {
                            var _a, _b;
...
function InteractiveEventModal({ $app, }) {
    const [modalId] = useState(randomStringId$2());
    ...
    return (jsx(Fragment, { children: jsxs("div", { id: modalId, "data-state": modalPlugin.modalState.value, className: `sx__interactive-event-modal${modalPlugin.isOpen.value ? ' is-open' : ''}`, children: [modalPlugin.config.movable && (jsx("div", { onMouseDown: startDrag, className: 'sx__interactive-event-modal__move-bar' })), calendarEvent && (jsxs(Fragment$1, { children: [modalPlugin.modalState.value === 'view' && (jsx(EventDisplay, { "$app": $app, calendarEvent: calendarEvent })), ['edit', 'add', 'edit_added'].includes(modalPlugin.modalState.value) && (jsx(EventForm, { "$app": $app, removeEditAddedEvent: removeEditAddedEvent })), modalPlugin.modalState.value === 'delete' && (jsx(DeleteActions, { "$app": $app }))] }))] }) }));
}
...
const createInteractiveEventModal = (config) => {
    ...
    const modalState = signal('view');
    const isEditingRecurringEvent = signal(false);
    let _$app;
    ...
    const calendarEventElement = signal(null);
    ...
    return definePlugin('eventModal', {
        ...
        formValidationErrors: allFieldsWithValidators.reduce((acc, fieldName) => {
            acc[fieldName] = signal(undefined);
            return acc;
        }, {}),
        modalState,
